...
> - **`src/data/catalog.json`** — derived from OpenNGC, © Mattia Verga,
>   Creative Commons Attribution-ShareAlike 4.0 (CC-BY-SA-4.0). Redistribution
>   of the catalog data must preserve that attribution and share-alike term.
> - **IBM Plex** fonts (loaded at runtime) — SIL Open Font License 1.1.
